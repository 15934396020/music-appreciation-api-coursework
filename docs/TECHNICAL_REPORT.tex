...
\title{Design and Implementation of a Music Appreciation and Discovery API}
\author{Manus AI}
\date{\today}
...
\noindent
\textbf{Module:} XJCO3011 - Web Services and Web Data \\
\textbf{Project:} Coursework 1 - Individual Web Services API Development Project
