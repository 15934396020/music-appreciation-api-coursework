...
| 2 | Review Deliverables | Review `docs/API_Documentation.pdf` and `docs/Technical_Report.pdf` to ensure they meet the coursework requirements (e.g., max 5 pages for the report). Review the generated HTML slides in `docs/presentation/` to ensure they are ready for the oral examination. |
...
- [x] Expanded seed data to 29 tracks across 8 genres.
...
- [x] Generated `Technical_Report.md` and converted it to `Technical_Report.pdf`.
